    ...
    <Layout>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-6 text-primary-foreground">
          <h1 className="mb-6 font-display text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold bg-gradient-primary bg-clip-text text-transparent whitespace-nowrap">
